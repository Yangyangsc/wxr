...
$(function () {
	...
	var userid = localStorage.login_data
	...
	function initShare(adata) {
		...
		var shareOption = {
			...
			link: "http://activity.litecoder.com/activity/activity-details.html?" + (activityid ? ('activityid=' + activityid) : '') + (channelid ? ('&channelid=' + channelid) : '') + (giftid ? ('&giftid=' + giftid) : '')
		};

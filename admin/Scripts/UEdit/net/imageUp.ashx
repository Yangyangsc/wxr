...
public class imageUp : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //string pathbase = "/staticfiles/html/information/images/";                                                          //保存路径
        string pathbase = @"D:\02.Web App\static\html\information\images\";                                                          //保存路径
        ...
        //上传图片
        Hashtable info;
        BlueBerry.Platform.BackOfficeWeb.Service.Uploader up = new BlueBerry.Platform.BackOfficeWeb.Service.Uploader();

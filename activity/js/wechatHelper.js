...
var wechatHelper = {
  ...
  hideCopyLink: function() {
    // 批量隐藏功能按钮接口
    wx.hideMenuItems({
      menuList: ['menuItem:copyUrl', 'menuItem:openWithSafari', 'menuItem:share:email',
  ...
  initToShare: function(shareOption, cacheKey, callback) {
    ...
    if (shareOption == null) {
      ...
      if (shareOption == null) { // 如果分享参数不存在复制默认值
        shareOption = {
          title: "2019第四届中国外星人千人峰会，等你来~",
          // imgUrl: location.protocol + "//" + location.host + "/images/share_default.jpg",
          imgUrl: 'http://image.huanxinkeji.cn/activity/cover/f96db9f2-643b-4aec-a115-00b29820cb1a.jpg',
          link: location.href
        };
      }
    } else {

...
*/
var co = require('co');
var departmentDao = require('../model/department');
...
class DepartmentController extends controllerBase {
    ...
    */
    initializeRouter(instance) {
        ...
        //#处理提交新增实体记录的路由配置
        this.app.post('/department', function (req, res) {
            co(instance.create(req, "department"))
                .then(result => { instance.responseResult(req,res,result) })
                .catch(result =>{ instance.responseResult(req,res,result) });
        });
        //#更换部门的上级部门
        this.app.put('/department/:id/changeheader', function (req, res) {
        ...
        //#获取详细记录的路由配置
        this.app.get('/department/:id', function (req, res) {
            co(instance.getDataById(req, "department"))
                .then(result => instance.responseResult(req,res,result))
                .catch(result => {instance.responseResult(req,res,result);});
        });
        //#处理更新实体记录的路由配置
        this.app.put('/department/:id', function (req, res) {
            co(instance.update(req, "department"))
                .then(result => instance.responseResult(req,res,result))
                .catch(result=> { instance.responseResult(req,res,result); });
        });
        //#处理删除实体记录的路由配置
        this.app.delete('/department/:id', function (req, res) {

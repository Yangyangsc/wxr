...
class ActivityticketModel extends daoBase {
    get getByIdSql() {return "select * from  act_ticket where ticket_id=? ";}
    get updateSql() {return "update act_ticket set ? where ticket_id=?";}
    get insertSql() {return "insert into act_ticket set ?";}
    get deleteSql() {return "delete from act_ticket where find_in_set(ticket_id,?)";}
    ///根据主键获取一条记录
    getBykey(Sql,id) {
